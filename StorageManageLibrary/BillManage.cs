...
namespace StorageManageLibrary
{
    ...
    public class BillManage
    {
        ...
        public string GetAddBillDetailSQL(BillDetail billdetail )
        {
            ...
            strSql.Append("BillDetailGuid,BillGuid,MaterialGuid,MaterialID,MaterialName,Spec,ProNo,CadNo,Unit,Qty,jz,scrq,Remark");
            strSql.Append(")");
            strSql.Append(" values (");
            ...
            strSql.Append("'" + billdetail.ProNo + "',");
            strSql.Append("'" + billdetail.CadNo + "',");
            strSql.Append("'" + billdetail.Unit + "',");
            //strSql.Append("'" + billdetail.Price + "',");
            strSql.Append("'" + billdetail.Qty + "',");           
            //strSql.Append("'" + billdetail.Total + "',");
            //strSql.Append("'" + billdetail.Zj + "',");
            //strSql.Append("'" + billdetail.Gh + "',");
            //strSql.Append("'" + billdetail.Bz + "',");
            //strSql.Append("'" + billdetail.Qd + "',");
            //strSql.Append("'" + billdetail.Cd + "',");
            strSql.Append("'" + billdetail.Jz + "',");
            //strSql.Append("'" + billdetail.Mz + "',");
            strSql.Append("'" + billdetail.Scrq + "',");
        ...
        public DataTable GetBillDetailData(string BillGuid)
        {
            ...
            try
            {
                string ps_Sql = "select  MaterialGuid,MaterialId,MaterialName,(select ClassName from V_MaterialClass  where  MaterialGuid=BillDetail.MaterialGuid) as ClassName,Spec,ProNo,CadNo,Unit,Qty,jz,scrq,Remark" +
                    " from BillDetail where BillGuid='" + BillGuid + "' order by SortID";
                DataTable pDTMain = pObj_Comm.ExeForDtl(ps_Sql);
        ...
        public DataTable GetBillDataImport_CN()
        {
            ...
            try
            {
                string ps_Sql = "select  BillGuid,BillAutoID as 编号,BillID as  单号,BillDate as 业务日期,DepotGuid as  库位,"
                   +" HandlePerson as 经手人,CreatePerson as 制单人, "
        ...
        public DataTable GetBillDataImport_CN(string strsql)
        {
            ...
            try
            {
                string ps_Sql = "select  BillGuid,BillAutoID as 编号,BillID as  单号,BillDate as 业务日期,DepotGuid as  库位," +
                    "HandlePerson as 经手人," +
                    "CreatePerson as 制单人,CreateDate as 制单时间,CheckPerson as 审核人," +
                     "CheckDate as  审核日期  from Bill   " + strsql + " order by CreateDate desc";
        ...
        public DataTable GetBillDataExport_CN()
        {
            ...
            try
            {
                string ps_Sql = "select  BillGuid,BillAutoID as 编号,BillID as  单号,BillDate as 业务日期,DepotGuid as  库位," +
                    "HandlePerson as 经手人," +
                    "CreatePerson as 制单人,CreateDate as 制单时间,CheckPerson as 审核人," +
                     "CheckDate as  审核日期  from Bill     where flag='E' order by CreateDate desc";
        ...
        public DataTable GetInDepotSumData(string strsql)
        {
            ...
            try
            {
                string ps_Sql = "   select  InterName,MaterialName,Spec,Unit,sum(Qty) as Qty,count(*) as billcount "
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable GetDepotSumData(string strsql)
        {

            CommonInterface pObj_Comm = CommonFactory.CreateInstance(CommonData.sql);
            try
            {
                string ps_Sql = "   select  V_OutDepotDetail.MaterialName,V_OutDepotDetail.Spec,V_OutDepotDetail.Unit,V_OutDepotDetail.Qty as OutQty "
                               + "  from  V_OutDepotDetail LEFT JOIN  V_InDepotDetail ON V_OutDepotDetail.BatchNo=V_InDepotDetail.BatchNo AND V_OutDepotDetail.MaterialId=V_InDepotDetail.MaterialId" + strsql 
                               + "    order by V_OutDepotDetail.InterName  ";
                //string ps_Sql = "   select  MaterialName,Spec,Unit,sum(Qty) as OutQty,count(*) as billcount"
                //               + "  from dbo.V_OutDepotDetail" + strsql +
                //               " group by InterName,MaterialName,Spec,Unit"
                //               + " order by InterName  "
                //               + " UNION ALL"+" select  MaterialName,Spec,Unit,sum(Qty) as InQty,count(*) as billcount"
        ...
        /// <param name="depot">仓库名</param>
        /// <returns></returns>
        public DataTable sp_GetDepotClassDetailSum(string BeginDate, string EndDate, string Depot, 
        ...
        /// <param name="depot">仓库名</param>
        /// <returns></returns>
        public DataTable sp_GetDepotClassTypeDetailSum(string BeginDate, string EndDate, string Depot, 
                                                   string MaterialID, string MaterialName, string Spec, string Classid)
        {
