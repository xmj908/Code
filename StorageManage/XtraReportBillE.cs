...
{
    public partial class XtraReportBillE : DevExpress.XtraReports.UI.XtraReport
    {
        public DataSet ds;
        public XtraReportBillE(DataSet dataset)
        {
            InitializeComponent();
        ...
        private void DataBind()
        {
            ...
            xrBarCode1.DataBindings.Add("Text", DataSource, "dtlBillDetail.MaterialId");
            decimal qty = 0;
            decimal total = 0;
